...
calendar_hot_reload_api := hot_reload.Module_API{
	...
	callbacks = {
		...
		hot_reload.Callback.Flags_Changed = rawptr(calendar_on_flags_changed),
		hot_reload.Callback.Copy = rawptr(calendar_on_text_copy),
		hot_reload.Callback.Cut = rawptr(calendar_on_text_cut),
		hot_reload.Callback.Paste = rawptr(calendar_on_text_paste),
		hot_reload.Callback.Select_All = rawptr(calendar_on_text_select_all),
		hot_reload.Callback.Insert_Text_Simple = rawptr(calendar_on_text_insert_simple),
		hot_reload.Callback.Insert_Text = rawptr(calendar_on_text_insert),
		hot_reload.Callback.Command = rawptr(calendar_on_text_command),
		hot_reload.Callback.Set_Marked = rawptr(calendar_on_text_set_marked),
		hot_reload.Callback.Unmark = rawptr(calendar_on_text_unmark),
		hot_reload.Callback.Has_Marked = rawptr(calendar_on_text_has_marked),
		hot_reload.Callback.Marked_Range = rawptr(calendar_on_text_range),
		hot_reload.Callback.Selected_Range = rawptr(calendar_on_text_range),
		hot_reload.Callback.Valid_Attributes = rawptr(calendar_on_text_valid_attributes),
		hot_reload.Callback.Attributed_Substring = rawptr(calendar_on_text_attributed_substring),
		hot_reload.Callback.Character_Index = rawptr(calendar_on_text_character_index),
		hot_reload.Callback.First_Rect = rawptr(calendar_on_text_first_rect),
